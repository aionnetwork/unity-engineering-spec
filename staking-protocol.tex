...
\begin{itemize}
    ...
    \item \textbf{\textit{Bonded}}: A coin is bonded if is has been cast as a \say{vote} (\S\ref{sc_design} to a staker in the Staker Registry. 
...
\begin{itemize}
    ...
    \item \textit{\textbf{Auto Rewards Delegation}}: Rewards earned by delegators in the system can be \say{auto-delegated}; i.e. coins earned as part of block rewards can be automatically cast to stake on behalf of the delegator.  
\end{itemize}
