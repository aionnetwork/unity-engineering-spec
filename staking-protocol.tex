...
\paragraph{Staker registry symmetric-key rights} \label{km_staker} A  (private) staker required to manage the following five (5) keys, each of which correspond to a distinct function: 
\begin{itemize}
