...
\begin{tikzpicture}[auto,>=latex']
    ...
    \node [block, below of=sc,node distance=1.95cm, align=center, minimum width=3.4cm, dashed] (dc3){Off-Chain\\Stake Pooling};
    
    \draw [<-] (sc) -- node{$calls$} (dc0);
    \draw [<-, dashed] (sc) -- node{} (dc1);
    \draw [<-] (sc) -- node{} (dc2);
    \draw [<-, dashed] (sc) -- node{} (dc3);
\end{tikzpicture}
